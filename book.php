...
<option>ZN-Jangaon</option>
 ...
 <center>  
      ...
      <label for="inputPassword4"> 
Train Class :</label>
      <select id="inputState" class="form-control" required name="class">
 ...
 <center><div class="form-group col-md-5" name="type">
    ...
    <input type ="date" id="inputState" class="form-control" min="<?php echo date('Y-m-d');?>" required name="Date">
    </div>
    ...
    <div class="form-row row justify-content-aroundd">
       ...
       <center><label for="inputState"  ><h8>NO OF PASSENGER-TICKETS :</h8></label></center>
      <center> <input type="number" name="number" required  min="1"  ></center>
       </div>
       <div class="form-row row justify-content-aroundd">
       <div class="form-group col-md-16" >
       <button type="submit" formaction="book_action.php"  class="button" name="login_submit" >Buy a Ticket</button>  
       </div>
       <div class="form-row row justify-content-aroundd"  >
       <div class="form-group col-md-16" >
       <button type="submit" class="button" formaction="book_action1.php" name="login_submit1" ><u>Sell a Ticket?<u></button>  
       </div>
</form>
</div>
</section>
