  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="register.php"><img src="https://img.icons8.com/bubbles/80/000000/add-user-male.png"/>Register&nbsp</a></li>

        <li><a href="sindex.php"><img src="https://img.icons8.com/bubbles/80/000000/user.png"/>User Sign In&nbsp</a></li>

        <li><a href="adminindex.php"><img src="https://img.icons8.com/bubbles/80/000000/admin-settings-male.png"/>Admin Sign In&nbsp</a></li>
