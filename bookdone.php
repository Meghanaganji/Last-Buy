...
<tr>
<td>
<div><td><a  href="print.php?pid='<?php echo $_SESSION['tno']?>' " target="_blank" ><button style="background-color: black ; border-color:black  "><h3><span style="color:white;"> Show Ticket<br> </span></h3></button></a></td></td>
</td>
</tr>
</body style="background-color: F5F1F0;">
</div>
...
<body>
    ...
    <div class="center">
        <a href="print.php?pid=<?php echo urlencode($_SESSION['tno']); ?>" target="_blank" class="button">Show Ticket</a>
    </div>
</body>
