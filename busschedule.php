...
<body >  
    <h2><center><b><img src="https://img.icons8.com/nolan/64/database.png"/>AVAILABLE BUS TICKETS <img src="https://img.icons8.com/ultraviolet/60/000000/train.png"/></center></b></h2>
    <div class="container">  
        <br />
...
$sql_transactionss="SELECT * FROM `pricebus` " ;
$result = $connect->query($sql_transactionss);
